...
import ma.enim.project.entity.*;
import ma.enim.project.entity.Client;
import ma.enim.project.entity.Paiement;
import ma.enim.project.service.ClientService;
import ma.enim.project.service.CommandeService;
import ma.enim.project.service.PaimentService;
...
//                        root.getChildren().forEach((e)->{ System.out.println(e.getValue().getName().get()); });
    ...
    public void close(ActionEvent mouseEvent) throws Throwable {
        ...
        ma.enim.project.controller.Client.Update.etat=false;
        stage.hide();
    ...
    public void client(ActionEvent actionEvent) throws SQLException, IOException, ClassNotFoundException {
        ...
        ma.enim.project.controller.Client client1= new ma.enim.project.controller.Client();
    ...
    public void Paiement(ActionEvent actionEvent) throws SQLException, IOException, ClassNotFoundException {
        ...
        ma.enim.project.controller.Paiement paiement= new ma.enim.project.controller.Paiement();
