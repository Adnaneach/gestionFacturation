...
public class home {
    ...
    public void showClient() {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/ma/enim/project/client.fxml"));
    ...
    public void showfacture(ActionEvent actionEvent) {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/ma/enim/project/tabfacture.fxml"));
            Parent root = loader.load();
    ...
    public void showproduct(ActionEvent actionEvent) {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/ma/enim/project/product.fxml"));
            Parent root = loader.load();
