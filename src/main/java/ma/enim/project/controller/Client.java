...
//            System.out.println(name.get());
            ...
            this.update.setOnAction(event -> {
                ...
                if(Update.etat) {
                    ...
                    ma.enim.project.entity.Client client= new ma.enim.project.entity.Client();
    ...
    public class Update extends Thread{
        ...
        public void loadClient() throws SQLException {
            ...
            try {
                ...
                List<ma.enim.project.entity.Client> clients = clientDao.getClients();
                Platform.runLater(() -> {
                    clientList.clear();
                    ...
                    try {
                        ...
                        for (ma.enim.project.entity.Client client : clients) {
