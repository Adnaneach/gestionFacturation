...
//            System.out.println(name.get());
            ...
            this.update.setOnAction(event -> {
                ...
                if(Update.etat) {
                    ...
                    ma.enim.project.entity.Paiement pay= new ma.enim.project.entity.Paiement();
    ...
    public class Update extends Thread{
        public void loadPaiement() throws SQLException {
            ...
            try {
                ...
                List<ma.enim.project.entity.Paiement> paiements =paiementDao.getAllPaiement();
                Platform.runLater(() -> {
                    try {
                        paiementList.clear();


                        for (ma.enim.project.entity.Paiement paiement : paiements) {
                            ...
                            ma.enim.project.entity.Client client=clientService.getClient(commande1.getClient());
