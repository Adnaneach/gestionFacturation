package ma.enim.project.controller;
...
import ma.enim.project.entity.Produit;
...
public class facture {
    ...
    public void produit(ActionEvent actionEvent) throws SQLException, IOException, ClassNotFoundException {
        ma.enim.project.controller.commande.Update.etat=false;
        ...
        public FactureModel(String id, Object com, Object cli,Object us) {
            ...
            this.update.setOnAction(_ -> {
                ...
                DetaileCommandeService detaileCommandeService= null;
                    ...
                    ma.enim.project.entity.Client c = clientService.getClient(commandeService.getCommande(Integer.parseInt(String.valueOf(com))).getClient());
...
//                 Add Invoice Header
                        ...
                        document.save("C:\\Users\\DELL\\Downloads\\GestionFacturationUp-master\\GestionFacturationUp-master\\project\\src\\main\\resources\\ma\\enim\\project\\facture.pdf");
                        System.out.println("pdf :: facture1.pdf !!!!!!!!!!!1");
                        System.out.println("Invoice PDF created successfully!");


                        MailService mailService = new MailService();
                        mailService.send(c.getEmail(), "Facture", "your facture is :", "C:\\Users\\DELL\\Downloads\\GestionFacturationUp-master\\GestionFacturationUp-master\\project\\src\\main\\resources\\ma\\enim\\project\\facture.pdf");
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
